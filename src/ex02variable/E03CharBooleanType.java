...
<<<<<<< HEAD
		...
		/*
		아스키코드 : 1byte로 표현할수 있는 문자(영문, 숫자)를 십진수코드로
			정의한것을 말한다.
			Ex) A => 65로 표현
			 	a => 97로 표현
...
=======
		...
		char ch1 = '가';
		//char chStr= '가나다라';[에러발생] 문자열이므로 char형 변수에 대입불가
		String chStr = "가나다라";
		System.out.println("ch1 = " + ch1);
		System.out.println("chStr = " + chStr);
		...
		/*
		 ...
		 Ex) A => 65
		     a => 97
		유니코드 : 1byte로 표현이 안 되는 문자(한글, 한자 등)는 2byte가 필요하고,
		이를 16진수로 정의한 값을 말한다.
		 */
		char ch2 = 'A';
		int num1 = 2;
		...
		System.out.println("ch4 = " + ch4 + ", ch4_1 = " + ch4_1
				+ ", ch4_1 = " + (int)ch4_1);
		/*
		 boolean 형: true 혹은 false 두 가지의 값만 가질 수 있는 데이터형으로 산술연산 (+,-,*,/)이나 비교연산 (<,>,=등)은 사용이 불가능하다.
		 단 논리연산은 가능하다.
		...
		System.out.println("bn3(And) = " + bn3);
		bn3 = bn1 || bn2;
		System.out.println("bn 3(0r) = "+ bn3);
		
		bn3 = '가' > 30000;//가 => 유니코드 44073 이므로 true 번환 됨.
		System.out.println("bn3 = " + bn3);
