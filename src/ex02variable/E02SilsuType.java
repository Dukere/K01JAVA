...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		/*
		실수 자료형
		-정수형 보다는 실수형이 더 큰 자료형이다. (0,1 사이에 무수한 실수가 존재하기 때문)
		...
		*/
		...
		/*
		 float와 long의 연산겨로가를 long으로 받고 싶다면
		 방법 1 : float를 long으로 형변환 후 연산하거나
		 방법 2 : 계산 결과 전체를 long으로 명시적(강제) 형변환 한다.
		 */
		long result2 = long1 + (long)float1;
		System.out.println("형변 변환 후 연산 = " + result2);
		...
		float f4 = (float)3.14;//형변환 후 대입 (권장사항 아님)
